...
import com.calhounhinshaw.freehandalpha.note_editor.Geometry;
import com.calhounhinshaw.freehandalpha.note_editor.Point;

import junit.framework.Assert;

public class GeometryTests extends AndroidTestCase {
	...
	public void testIntersectLineIntoSegment () {
		...
		Point result = Geometry.intersectLineIntoSegment(l1, l2, s1, s2);
		...
		result = Geometry.intersectLineIntoSegment(l1, l2, s1, s2);
...
//		Assert.assertEquals(6, result);
	...
	public void testTraceCircularPath () {
		...
		result = Geometry.traceCircularPath(center, radius, clockwise, from, to);
